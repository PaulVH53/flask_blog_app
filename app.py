...
from models.models import db, User, Blog, Comment
from models.forms import BlogForm, LoginForm, CommentForm
...
def create():
    ...
    if form.validate_on_submit():
        ...
        new_blog.date_posted = datetime.now(timezone('America/Lima'))
...
def comment(blog_id):
    ...
    form = CommentForm()
    if form.validate_on_submit():
        date_posted = datetime.now(timezone('America/Lima'))
